...
class _ProjectListScreenState extends ConsumerState<ProjectListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalScripts =
        stats.values.fold(0, (sum, item) => sum + item.scripts);
    final totalStoryboards =
        stats.values.fold(0, (sum, item) => sum + item.storyboards);
    ...
    return LayoutBuilder(builder: (context, constraints) {
        ...
        children: [
          Wrap(
            ...
            children: [
              Text(
                l10n.projectTitle,
                style: TextStyle(fontSize: compact ? 28 : 36, fontWeight: FontWeight.w900, letterSpacing: 0.5, color: df.textPrimary),
              ),
              Container(
          ...
          Text(
            ...
            style: TextStyle(fontSize: compact ? 14 : 16, color: df.textSecondary),
          ),
        ],
      );
      ...
      final newProjectBtn = FilledButton.icon(
        ...
        label: Text(l10n.projectNewProject, style: TextStyle(fontSize: compact ? 15 : 16, fontWeight: FontWeight.w700)),
        style: ButtonStyle(
          padding: WidgetStatePropertyAll(
            EdgeInsets.symmetric(horizontal: compact ? 16 : 32, vertical: compact ? 16 : 20),
          ),
      ...
      final searchBar = Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.search_rounded, size: 20, color: df.textTertiary),
            contentPadding: EdgeInsets.symmetric(horizontal: compact ? 16 : 20, vertical: 0),
      ...
      final viewSwitcher = Container(
        ...
        decoration: BoxDecoration(
          color: isDark ? const Color(0xFF1C1C24).withValues(alpha: 0.6) : Colors.black.withValues(alpha: 0.04),
          borderRadius: BorderRadius.circular(28),
        ),
        child: Row(
          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _isGridView ? (isDark ? const Color(0xFF2C2C34) : Colors.white) : Colors.transparent,
                  borderRadius: BorderRadius.circular(22),
...
class _OverviewBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: df.surfaceMuted.withValues(alpha: 0.6),
        borderRadius: BorderRadius.circular(24),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: compact ? 14 : 16, color: df.textSecondary),
                  ...
                  children: [
                    ...
                    if (showActions) ...[
                      ...
                      IconButton(
                        ...
                        icon: Icon(Icons.edit_outlined, size: 18, color: df.textSecondary),
                      ...
                      IconButton(
                        ...
                        icon: Icon(Icons.delete_outline, size: 18, color: df.textSecondary),
...
class _ProjectListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final actionsRow = Row(
      ...
      children: [
        IconButton(
          visualDensity: VisualDensity.compact,
          tooltip: l10n.commonEdit,
          icon: Icon(Icons.edit_outlined, size: compact ? 16 : 18, color: df.textSecondary),
          onPressed: onEdit,
        ),
        IconButton(
          visualDensity: VisualDensity.compact,
          tooltip: l10n.commonDelete,
          icon: Icon(Icons.delete_outline, size: compact ? 16 : 18, color: df.textSecondary),
          onPressed: onDelete,
        ),
      ],
    );
      ...
      contentWidget = Row(
        ...
        children: [
          Container(
            ...
            child: Icon(
              project.projectType == 'script' ? Icons.description_outlined : Icons.menu_book_outlined,
              color: df.primary,
              size: 18,
            ),
          ),
                ...
                Row(
                  children: [
                    ...
                    if ((project.artStyle ?? '').isNotEmpty) ...[
                      const SizedBox(width: 8),
                      _RoundTag(text: styleLabel ?? project.artStyle!, color: df.accent),
                    ],
                  ],
                ),
                const SizedBox(height: 4),
    ...
    return InkWell(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: compact ? 12 : 20, vertical: compact ? 10 : 16),
        decoration: BoxDecoration(
          color: isDark
