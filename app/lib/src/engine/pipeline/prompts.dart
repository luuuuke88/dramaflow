...
String scriptGenUser(String novelTitle, String novelContent, int episodeCount) =>
...
String repairUser(String originalUser, String badOutput, String parseError) {
  final head =
      badOutput.length > 200 ? badOutput.substring(0, 200) : badOutput;
