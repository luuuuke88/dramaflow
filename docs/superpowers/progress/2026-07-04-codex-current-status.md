...
- `cd app && flutter test`：通过，420 tests。
...
- 移动端不是空壳：390px widget tests 已覆盖项目、章节、剧本、素材、制作、工作台入口/重排/素材层添加/素材层属性编辑/媒体库按播放头添加/本镜候选选择/本镜候选视频全屏预览/本镜候选删除确认/本镜时长编辑/清空已选轨道确认/合成成功结果/批量移动起点/批量改轨/批量裁剪尾部/按播放头切分、配音、任务、Agent 入口和设置路径。
