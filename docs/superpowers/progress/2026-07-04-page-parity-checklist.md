...
Known Gaps: Full WebAV/NLE parity is not implemented: Android dissolve rendering, Web transition/filter visual rendering, Web cross-shot dissolve, Web whip-pan rendering, multi-layer timeline editing, and drag-based clip editing are not proven.
