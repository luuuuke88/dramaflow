...
C3 Task 4: code committed (853e54d; project-model request build/preflight, persisted accepted IDs, no-resubmit cold recovery, upstream cancellation plus race protection, assistant/workbench same path; full 536 tests, analyze, and macOS debug build green; independent review pending.)
